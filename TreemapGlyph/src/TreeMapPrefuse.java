...
import doutorado.tese.dynabeans.DynaBeanFactory;
 ...
 */
public class TreeMapPrefuse extends Display {

    public static final String TREE_CHI = "C:\\Users\\Anderson Soares\\Documents\\workspace\\Prefuse-master\\data\\chi-ontology.xml.gz";
    ...
    public TreeMapPrefuse(Tree t, String label) {
...
//        layout.add(new SquarifiedTreeMapLayout(tree));
        SquarifiedTreeMapLayout s = new SquarifiedTreeMapLayout(tree, 4);
        layout.add(s);
...
//        });
    ...
    public static InputStream testeXML() {
...
//        }
        ...
        StringBuilder xmlFull = new StringBuilder();
        xmlFull.append("<?xml version=\"1.0\"?>\n");
        xmlFull.append("<tree>");
        xmlFull.append("<declarations>\n");
        xmlFull.append("<attributeDecl type=\"String\" name=\"name\"/>\n");
        xmlFull.append("</declarations>");
        xmlFull.append("<branch nome=\"Root\">\n");
        xmlFull.append("\t<branch nome=\"GASOLINA\">\n");
        XMLCreator creator = new XMLCreator();
        String item = creator.montarXML(bean);
        xmlFull.append("\t").append(item).append("\n");
        xmlFull.append("\t</branch>\n");//fim gasolina
        xmlFull.append("\t<branch nome=\"DIESEL\">\n");
        String item2 = creator.montarXML(bean);
        xmlFull.append("\t").append(item2).append("\n");
        xmlFull.append("\t</branch>\n");//fim diesel
        xmlFull.append("</branch>");
        xmlFull.append("</tree>");
//        System.out.println(xmlFull);

        InputStream xmlStream = new ByteArrayInputStream(xmlFull.toString().getBytes());
...
//            t = (Tree) new TreeMLReader().readGraph(datafile);
            t = (Tree) new TreeMLReader().readGraph(testeXML());
            System.out.println("t.isValidTree()?" + t.isValidTree());
        } catch (Exception e) {
            e.printStackTrace();
            System.exit(1);
        }
        ...
        final TreeMapPrefuse treemap = new TreeMapPrefuse(t, label);
