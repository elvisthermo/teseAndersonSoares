...
//    }
    ...
    private Point centralizarLegenda(Rect rect, Graphics2D g2d) {
        int stringW = (int) Math.round(g2d.getFontMetrics().getStringBounds(this.label, g2d).getCenterX());
        int stringH = (int) Math.round(g2d.getFontMetrics().getStringBounds(this.label, g2d).getCenterY());
